...
public:
    ...
    epaper_ui::SettingsSoundPageState BuildState(bool sound_feedback_enabled,
                                                 bool review_playback_enabled) const;
...
private:
    // Same mapping the Wi-Fi page uses: focus is part of the toggle's visual state, not a
    // separate ring drawn over it.
